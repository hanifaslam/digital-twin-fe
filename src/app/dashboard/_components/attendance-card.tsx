...
export const AttendanceCard = React.memo(
  ({
    ...
    return (
      <div className="rounded-2xl bg-primary p-4 sm:p-5 text-white shadow-lg">
        <div className="mb-4 flex items-center gap-3">
          {isLoading ? (
            <>
              <Skeleton className="h-12 w-12 rounded-full bg-primary/50" />
              <div className="space-y-2">
                <Skeleton className="h-4 w-32 bg-primary/50" />
                <Skeleton className="h-3 w-20 bg-primary/50" />
              </div>
            </>
          ) : (
            <>
              ...
              <div className="rounded-lg border bg-gray-50/60 p-2 sm:p-3">
                ...
                <Button
                  ...
                  className={cn(
                    ...
                    hasAttended
                      ? 'bg-primary/80 text-white hover:bg-primary/80 cursor-default pointer-events-none'
