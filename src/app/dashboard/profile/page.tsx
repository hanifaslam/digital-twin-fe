...
export default function ProfilePage() {
        ...
        try {
          ...
          if (res.data?.profile_picture) {
            ...
            useAuthStore.setState({
              user: { ...user!, profile_picture: res.data.profile_picture }
            })
          }
  ...
  useEffect(() => {
    ...
    else if (lecturer?.phone_number) setPhone(lecturer.phone_number)
  }, [user, lecturer])

  const initialEmail = user?.email || lecturer?.email || ''
  const initialPhone = user?.phone_number || lecturer?.phone_number || ''
